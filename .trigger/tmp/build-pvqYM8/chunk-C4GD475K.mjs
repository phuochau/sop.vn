...
var require_dist = __commonJS({
  "node_modules/@fal-ai/client/node_modules/eventsource-parser/dist/index.cjs"(exports) {
    "use strict";
    init_esm();
...
import_client.fal.config({ credentials: process.env.FAL_API_KEY });
async function transcribeVideo(signedUrl) {
  const result = await import_client.fal.subscribe("fal-ai/whisper", {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    input: {
      audio_url: signedUrl,
      task: "transcribe",
...
__name(transcribeVideo, "transcribeVideo");

// src/trigger/stages/transcribe.ts
async function runTranscribe(signedVideoUrl) {
  return transcribeVideo(signedVideoUrl);
}
__name(runTranscribe, "runTranscribe");

export {
  runTranscribe
};
//# sourceMappingURL=chunk-C4GD475K.mjs.map
